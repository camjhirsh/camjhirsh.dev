    ...
    <div className="wrapper">
      ...
      <div className="section one">
        <p>
          ...
          Though I have an intesrest in genetic engineering, I have transitioned to the realm of software development, as my love of building, efficiency, and the rapid
          ...
          to be helpful and kind. Currently based in San Diego due the remote nature of work, but open to relocation with the hopes of
